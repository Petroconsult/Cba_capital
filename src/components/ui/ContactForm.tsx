...
export default function ContactForm() {
  ...
  const handleSubmit = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    const required: (keyof EnquiryFormData)[] = [
      "category", "firstName", "surname", "email",
      "companyName", "telephone", "description",
    ];
  ...
  const labelClass = "text-xs font-bold tracking-widest uppercase text-[#6b7f99] mb-1.5 block";
      ...
      <div className="w-full max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="bg-[var(--navy)] px-8 py-6">
            <h2 className="text-white text-2xl font-semibold tracking-tight">Get in Touch</h2>
            <p className="text-[#8fa3bf] text-sm mt-1">We'll get back to you within 24 hours.</p>
          </div>
          <div className="flex flex-col items-center justify-center py-20 px-8 text-center">
            ...
            <h3 className="text-2xl font-black text-[var(--navy)] mb-3">Enquiry Received</h3>
        ...
        <div className="px-8 py-8 space-y-7">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
              ...
              <input id="surname" name="surname" type="text" placeholder="Smith"
                value={form.surname} onChange={handleChange} className={inputClass} />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
              ...
              <input id="telephone" name="telephone" type="tel" placeholder="+1 (555) 000-0000"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              ...
              <input id="companyName" name="companyName" type="text" placeholder="Acme Corp"
                value={form.companyName} onChange={handleChange} className={inputClass} />
            </div>
            <div>
              ...
              <input id="companyWebsite" name="companyWebsite" type="url" placeholder="https://acmecorp.com"
                value={form.companyWebsite} onChange={handleChange} className={inputClass} />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              name="description"
              rows={5}
              placeholder="Tell us about your business and what you're looking to achieve with CBA Capital..."
